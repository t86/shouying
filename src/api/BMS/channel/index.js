...
export default {
    // 批量删除缴款单渠道类别
    reqBatchDelRptJkCnl: params => axios.post(`${base.htgl}/rpt/cfg/batch_del_rpt_jk_cnl`, params),
  
    // 读取缴款单支付渠道类别列表
    reqGetRptJkCnlList: params => axios.post(`${base.htgl}/rpt/cfg/get_rpt_jk_cnl_list `, params),

...
const article = {
    ...
    // 读取仓库进销存表
    requestrpt_get_store_invt_reps(data) {
        return axios.post(`${base.htgl}/rpt_erp/get_store_invt_reps`, data);
    },

    // 导出仓库进销存表
    reqExportStoreInvtReps: params => axios.binaryFilePost(`${base.htgl}/rpt_erp/exp_store_invt_reps`, params),

 ...
 */
import allRight from '@/assets/card-imgs/new-allRight.png'
// cardOptions图片
...
export const orderSaveWineOptions = [
  {
    icon: require('@/assets/order-img/new-icon-save.png'),
    id: 1,
    name: "存酒"
  },
  {
    icon: require('@/assets/order-img/new-icon-get.png'),
    id: 2,
    name: "取酒"
  },
  {
    icon: require('@/assets/order-img/new-icon-cg.png'),
    id: 3,
    name: "充公"
  },
]
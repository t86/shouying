<template>
  <div>
    <!-- 手机号选择会员卡 -->
    <el-drawer
      :title="type == 1 ? '服务码选择预订金' : '手机号选择预订金'"
      :visible.sync="show"
      :append-to-body="true"
        ...
        <div class="container">
          <div class="left">
            <div class="session">
              ...
              <p class="tips red m-b-2">选择要使用的预订金</p>
              <div class="table">
                <div class="thead">
                  <div
                    class="tr"
                  ...
                  >
                    <div class="th">序号</div>
                    <div class="th">预订金Id</div>
                    <div class="th">营业日</div>
                    <div class="th">卡台名称</div>
                    <div class="th">预订金类型</div>
                    <div class="th">预订金金额</div>
                    <div class="th">操作</div>
                  </div>
                </div>
                <div class="tbody">
                  ...
                  >
                    ...
                    <div class="td one-txt-cut">{{ item.id }}</div>
  ...
  methods: {
    ...
    async getTableData() {
      ...
      if (result) {
        ...
        try {
          const res = await api_money.reqGetPhonePrepaysFCsm(params);
          if (res.code == 1) {

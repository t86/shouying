<template>
  ...
  font-weight: 600;
  color: #FFFFFF;">导出Excel</el-button>
        </div>
        <div class="table">
          <div class="thead">
          ...
          <div class="tbody">
            <div class="tr" layout="row" layout-align="start center" v-for="(item, index) in tableData" :key="index">
...
@import "../../style/money/newDrawerMinDetail.less";

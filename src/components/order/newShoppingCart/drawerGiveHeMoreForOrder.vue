  ...
  <div class="new-give-more">
    ...
    >
      ...
      <div class="content">
        ...
        <!-- 批量优惠/批量优惠2 -->
        <div v-if="status==6 || status==7" class="new-seal-many">
          <div v-if="subStatus == 1">
            ...
            <div class="table">
              <div class="thead">
                <div class="tr"  layout="row" layout-align="space-between center">
                  <div class="th">
                    <el-checkbox class="el-checkbox-tr" :indeterminate="isIndeterminate" v-model="checkAll" @change="changeCheckBox('all')">全选</el-checkbox>
                  </div>
                  <div class="th">名称</div>
                  <div class="th">数量</div>
        ...
        <!-- 提交按钮 -->
        <div class="new-form-btn " layout="row" layout-align="center center">

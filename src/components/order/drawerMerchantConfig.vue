      ...
      <div class="session p-5 fs14">
        <div class="top">
          <el-button
            ...
            @click.native="showAddMerchant = true"
            >新增</el-button
          >
        </div>
        <div class="tips">
          <p class="fs12">
            1、微信、会员卡、支付宝渠道支付的滞留金，不允许删除；如在清台时未使用完，将会在清台后退回到客人账户
          </p>
          <p class="fs12">
            2、除微信、会员卡、支付宝渠道外，其他渠道如在清台时未使用或未删除，将不允许继续进行清台操作
          </p>
        </div>
        ...
        <div class="table">
          ...
          <div class="tbody">
            ...
            >
              ...
              <div class="td">
                <span class="primary-link cursor" @click="changeMerchant(item)"
                  >转滞留金</span
                >
                <span
                  class="primary-link cursor"
                  v-if="item.b == 1"
                  @click="backHandle(item)"
                  >退款</span
                >
                <span
                  class="primary-link cursor"

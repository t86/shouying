    ...
    <div class="table">
      <div class="thead">
        <div class="tr" layout="row" layout-align="start center">
          ...
          <div class="th">赠送积分规则</div>
          <div class="th">消费送积分-门槛金额</div>
...
import drawerAddOrUpdatePointToVip from "@/components/vip/onlineMakeMoney/drawerAddOrUpdatePointToVip.vue";
export default {
  data() {
    return {
      checked: false,

    ...
    <div class="vip pointRecords">
      ...
      <div class="search m-t-2 m-b-4">
        ...
        <div class="row">
          ...
          <el-select v-model="typeVal" size="small" placeholder="请选择类型" style="width: 200px">
          ...
          <div class="tbody">
            <div class="tr" v-for="(item, index) in tableData" :key="index" layout="row"
              ...
              <div class="td" :style="{
                ...
                <span @click="printHandle(item)">打印小票</span>
              </div>
            </div>
...
@import "../../style/vip/pointRecords.less";
</style>
<style>

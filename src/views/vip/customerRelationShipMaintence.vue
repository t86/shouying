    ...
    <div class="vip ">
      ...
      <div class="search m-t-2 m-b-4">
        <div class="row" layout="row" layout-align="start center">
          ...
          <el-select style="width: 154px" v-model="form.personVal" filterable remote reserve-keyword
            placeholder="输入员工号可查询" :remote-method="remoteMethod" :loading="remoteLoading" size="small">

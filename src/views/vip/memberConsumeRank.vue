        ...
        <div class="table">
          <div class="thead">
            <div class="tr" layout="row" layout-align="space-between center">
              ...
              <div class="th">消费总额</div>
              <div class="th">消费金额（赠送）</div>
              <div class="th">消费金额（储值）</div>
            </div>
          </div>
          <div class="tbody">
...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      ...
      try {
        const res = await api_vip.reqGetMbCardTopConsume(params);
        if (res.code == 1) {
    ...
    async exportExcel() {
      ...
      try {
        const res = await api_vip.reqExportMbCardTopConsume(params);
        if (!res.msg) {

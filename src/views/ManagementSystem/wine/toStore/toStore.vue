...
<!-- 待充公 -->
  <div class="to-store">
    <div class="top" layout="row" layout-align="start center">
      ...
      <el-input v-model="keyword" style="width:200px" class="m-r-2" size="small" placeholder="充公人/商品/卡台"></el-input>
      <el-button type="primary" size="small" @click="getTableData">查询</el-button>
      <el-button size="small" @click="resetHandle">重置</el-button>
    </div>
    <div class="btn-area m-t-4">
      <el-button type="primary" size="small" @click="toLibSureHandle">确认入库</el-button>
    ...
    <!-- 编辑待充公 -->
    <drawerEditToStoreInfo v-model="showEditDrawer" :currentWineInfo="currentWineInfo" @getTableData="getTableData" />

<template>
  <div class="user-list">
    ...
    <div class="btn-area m-t-4">
      <el-button type="primary" size="small" @click="openOrCloseMsgHandle(1)">开启短信</el-button>
      <el-button type="primary" size="small" @click="openOrCloseMsgHandle(2)">关闭短信</el-button>
      <el-button type="primary" size="small" @click="updateUserInfo(1)">编辑姓名</el-button>
      <el-button type="primary" size="small" @click="updateUserInfo(2)">更改手机号</el-button>
      <el-button type="primary" size="small" @click="addBlackList">加入黑名单</el-button>
    </div>
    ...
    <!-- 修改姓名/手机号 -->
    <drawerUpdateAuthInfo v-model="showDrawer" :status="status" :userInfo="currentUserInfo" @getTableData="getTableData" />

      ...
      <div class="table">
        <div class="thead">
          <div class="tr" layout="row" layout-align="space-between center">
            ...
            <div class="th">单号</div>
            <div class="th">空瓶出库操作人</div>
            <div class="th">空瓶出库时间</div>
          </div>
        </div>
        <div class="tbody">
          <div
...
<script>
import drawerHC from "./emptyOutLibCom/drawerHc.vue";
import drawerDetail from "./emptyOutLibCom/drawerDetail.vue";
export default {
  data() {
    return {
  ...
  methods: {
    async getTableData() {
      ...
      try {
        const res = await this.$api.ERP.emptyLib.getEmptyOutLibList(params);
        if (res.code == 1) {

  ...
  <div>
    ...
    >
      <div class="session p-5" id="print">
        <h3 class="show" style="text-align:center">其他出库单</h3>
        <!-- 头部信息 -->
        <div class="form">
            ...
            <div class="table border">
              ...
              <div class="tbody">
                <div class="tr" layout="row"  v-for="(item, i) in tableData" :key="item.id">
                  ...
                  <div class="td">{{(item.sa/item.c).toFixed(2)}}</div>
            ...
            <div class="table border">
              <div class="thead">
                <div class="tr" layout="row">
                  <div class="th">序号</div>
                  <div class="th">物料名称</div>
                  <div class="th">红冲操作员名称</div>
                  <div class="th">红冲数量</div>
                  <div class="th">红冲成本小计</div>
                  <div class="th">红冲单位名称</div>
      ...
      <div class="form-btn" layout="row" layout-align="center center">
        ...
        <el-button type="primary" v-if="info.status == '已完成'" @click="emitHandle(3)">整单红冲</el-button>
      </div>
    </el-drawer>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getAllData(){
      ...
      try {
        const res = await this.$api.ERP.sout.requestsoutget_f_view(params)
        if(res.code == 1) {
          this.info = res.data || {}

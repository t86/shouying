...
export default {
  ...
  methods: {
    ...
    // 滚动最大高度
    RollMaxHeight(i){
      var g = document.getElementsByClassName("out_sum-rkrq")[0].clientHeight;
      var s = i - 48 - 60 - 55 - g;
      this.MaxHeight = s
    ...
    // 获取管理列表内容
    demand(){
      this.$api.ERP.rpt_erp.requestrpt_erpout_sum({
        begin_day: this.Inbound.date[0],
        end_day: this.Inbound.date[1],
        out_store_id: this.Inbound.ckid || 0,
...
<style>
    ...
    .out_sum .out_sum-headline {
        font-size: 30px;
        font-weight: bold;
        color: #40404e;
    }

    .out_sum .out_sum-controller {
        margin-top: 20px;
        margin-bottom: 30px;
    }

    .out_sum .out_sum-rkrq {
        width: 100%;
        color: #40404e;
        overflow: hidden;
        font-size: 13px;
    ...
    .out_sum .out_sum-rkrq .rkrq {
        display: inline-flex;
        align-items: center;
        margin: 0 0 14px 0;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(1) {
        width: 670px !important;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(2) {
        width: 275px !important;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(3) {
        width: 275px !important;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(4) {
        width: 275px !important;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(5) {
        width: 275px !important;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(6) {
        width: 190px !important;
        margin-right: 10px;
    }

    .out_sum .out_sum-rkrq .rkrq:nth-child(7) {
        width: 255px !important;
    }

    .out_sum .out_sum-rkrq .rkrq .danxk {
        height: 34px;
        margin-right: 10px;
        display: inline-flex;
        align-items: center;
    ...
    .out_sum .out_sum-rkrq .rkrq .danxk img {
        display: inline-block;
        width: 12px;
        height: 12px;
        margin-right: 6px;
    ...
    .out_sum .out_sum-rkrq .rkrq .danxk .el-radio-button {
        margin: 0 4px;
        box-shadow: none !important;
    }

    .out_sum .out_sum-rkrq .rkrq .danxk .el-radio-button__inner {
    ...
    .out_sum .out_sum-rkrq .rkrq .danxk .el-radio-button__orig-radio:checked + .el-radio-button__inner {
    ...
    .out_sum .el-date-editor.el-input {
        width: 220px;
    }
    ...
    .out_sum .zhuixiaoi .mmodity tr th {
        height: 36px;
        line-height: 36px;
        text-align: left;
        font-weight: 600;
    ...
    .out_sum .zhuixiaoi .limiting .drag-list td {
        height: 36px;
        line-height: 36px;
        text-align: left;
        white-space: normal;
    ...
    .out_sum table thead tr th, .out_sum table tbody tr td {
        font-size: 14px;
    }

    .out_sum .zhuixiaoi .limiting .drag-list {
        border-top: solid 1px #f5f5f5;
        display: block;
        display: flex;
    }

    .out_sum .zhuixiaoi .mmodity {
        width: 100%;
        display: block;
    }

    .out_sum .zhuixiaoi .mmodity tr {
        background-color: #f5f5f5;
        display: flex;
    }

    .out_sum .zhuixiaoi .limiting {
    ...
    .out_sum .drag-list td:nth-of-type(1), .out_sum .mmodity th:nth-of-type(1) {
        width: 70px
    }

    .out_sum .mmodity th:nth-of-type(2), .out_sum .drag-list td:nth-of-type(2) {
        width: 120px
    }

    .out_sum .drag-list td:nth-of-type(3), .out_sum .mmodity th:nth-of-type(3) {
        width: 120px;
    }

    .out_sum .drag-list td:nth-of-type(4), .out_sum .mmodity th:nth-of-type(4) {
        width: 200px;
    }

    .out_sum .drag-list td:nth-of-type(5), .out_sum .mmodity th:nth-of-type(5) {
        width: 150px;
    }

    .out_sum .drag-list td:nth-of-type(6), .out_sum .mmodity th:nth-of-type(6) {
        width: 150px;
    }

    .out_sum .drag-list td:nth-of-type(7), .out_sum .mmodity th:nth-of-type(7) {
        width: 120px;
    }

    .out_sum .drag-list td:nth-of-type(8), .out_sum .mmodity th:nth-of-type(8) {
        width: 120px;
    }

    .out_sum .drag-list td:nth-of-type(9), .out_sum .mmodity th:nth-of-type(9) {
        width: 120px;
    }

    .out_sum .drag-list td:nth-of-type(10), .out_sum .mmodity th:nth-of-type(10) {
        width: 120px;
    }

    .out_sum .drag-list:nth-of-type(odd) {
        background-color: #f9f9f9;
        color: #40404e;
    }

    .out_sum .drag-list:nth-of-type(even) {
        background-color: #f5f5f5;
        color: #40404e;
    }

    .out_sum .zhuixiaoi .el-checkbox__label {
        color: #40404e;
    }

    /*  */
    .out_sum .zhuixiaoi .chaoguogai {
        height: 20px;
        /* text-align: center; */
        line-height: 20px;
        width: 136px;
    ...
    /* 日期选择器 */
    .out_sum .out_sum-rkrq .rkrq .el-range-editor .el-range-input {
        background-color: rgba(0, 0, 0, 0);
        color: #40404e;
    }

    .out_sum .out_sum-rkrq .rkrq .el-date-editor .el-range-separator, .out_sum .out_sum-rkrq .rkrq .el-date-editor .el-range__icon {
        color: #40404e;
        line-height: 22px;
    }
    ...
    .out_sum .Pagination .el-pagination.is-background .btn-next, .out_sum .Pagination .el-pagination.is-background .btn-prev, .out_sum .Pagination .el-pagination.is-background .el-pager li {
        background-color: rgba(0, 0, 0, 0);
        border: 1px solid #606266;
        color: #40404e;
    }

    .out_sum .Pagination .btn-prev {
        background-color: rgba(0, 0, 0, 0);
        border: 1px solid #606266;
    }

    .out_sum .Pagination .el-pagination {
        padding: 0;
    }

    .out_sum .Pagination .el-pagination .btn-next .el-icon, .out_sum .Pagination .el-pagination .btn-prev .el-icon {
        color: #40404e;
    }

    .out_sum .Pagination .el-pagination.is-background .el-pager li:not(.disabled).active {
        color: #409EFF;
        background-color: rgba(0, 0, 0, 0);

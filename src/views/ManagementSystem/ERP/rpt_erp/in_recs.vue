<template>
    <div class="in_recs">
        ...
        <div class="in_recs-rkrq">
            ...
            <div class="rkrq">
                <span>入库仓库：</span>
                <el-select v-model="Inbound.ckid" placeholder="全部" @change="demand" clearable>
            ...
            <div class="rkrq">
                <span>供应商：</span>
                <el-select v-model="Inbound.sup" placeholder="全部" @change="demand" clearable>
                    <el-option label="全部" value="0"></el-option>
                    <el-option v-for="(item) in suppliers" :key="item.id" :label="item.n" :value="item.id"></el-option>
                </el-select>
            </div>
            <div class="rkrq">
                <span>一级分类：</span>
                <el-select v-model="stair" placeholder="全部" @change="demand" clearable>
                    <el-option label="全部" value="0"></el-option>
            ...
            <div class="rkrq">
                <span>二级分类：</span>
                <el-select v-model="twin" placeholder="全部" @change="demand" clearable>
                    <el-option label="全部" value="0"></el-option>
            ...
            <div class="meisfgr" id="allexportareport" style="display: inline-block;">
                ...
                'max-height':`${MaxHeight}px`
                    ...
                    <tr v-for="(item,i) in tableData" :key="i" class="drag-list">
                        ...
                        <td>
                            <div class="alignment">{{item.ip}}</div>
                        </td>
                        <td>
...
export default {
  ...
  methods: {
    ...
    // 滚动最大高度
    RollMaxHeight(i){
      var g = document.getElementsByClassName("in_recs-rkrq")[0].clientHeight;
      var s = i - 48 - 60 - 90 - g;
      this.MaxHeight = s
    ...
    // 获取管理列表内容
    demand(){
      this.$api.ERP.rpt_erp.requestrpt_erpin_recs({
        ...
        supplier_id: this.Inbound.sup || 0,
...
<style>
    ...
    .in_recs .in_recs-headline {
        font-size: 30px;
        font-weight: bold;
        color: #40404e;
    }

    .in_recs .in_recs-controller {
        margin-top: 20px;
        margin-bottom: 30px;
    }

    .in_recs .in_recs-rkrq {
        width: 100%;
        color: #40404e;
        overflow: hidden;
        font-size: 13px;
    ...
    .in_recs .in_recs-rkrq .rkrq {
        display: inline-flex;
        align-items: center;
        margin: 0 0 14px 0;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(1) {
        width: 670px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(2) {
        width: 275px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(3) {
        width: 275px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(4) {
        width: 275px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(5) {
        width: 275px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(6) {
        width: 275px !important;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(7) {
        width: 190px !important;
        margin-right: 10px;
    }

    .in_recs .in_recs-rkrq .rkrq:nth-child(8) {
        width: 255px !important;
    }

    .in_recs .in_recs-rkrq .rkrq .danxk {
        height: 34px;
        margin-right: 10px;
        display: inline-flex;
        align-items: center;
    ...
    .in_recs .in_recs-rkrq .rkrq .danxk img {
    ...
    .in_recs .in_recs-rkrq .rkrq .danxk .el-radio-button {
        margin: 0 4px;
        box-shadow: none !important;
    }

    .in_recs .in_recs-rkrq .rkrq .danxk .el-radio-button__inner {
    ...
    .in_recs .in_recs-rkrq .rkrq .danxk .el-radio-button__orig-radio:checked + .el-radio-button__inner {
    ...
    .in_recs .el-date-editor.el-input {
        width: 220px;
    }
    ...
    .in_recs table thead tr th, .in_recs table tbody tr td {
        font-size: 14px;
    }
    ...
    .in_recs .zhuixiaoi .mmodity tr th {
        height: 36px;
        line-height: 36px;
        text-align: left;
        font-weight: 600;
    ...
    .in_recs .zhuixiaoi .limiting .drag-list td {
        height: 36px;
        line-height: 36px;
        text-align: left;
        white-space: normal;
    ...
    .in_recs .zhuixiaoi .limiting .drag-list {
        border-top: solid 1px #f5f5f5;
        display: block;
        display: flex;
    }

    .in_recs .zhuixiaoi .mmodity {
        width: 100%;
        display: block;
    }

    .in_recs .zhuixiaoi .mmodity tr {
        background-color: #f5f5f5;
        display: flex;
    }

    .in_recs .zhuixiaoi .limiting {
    ...
    .in_recs .drag-list td:nth-of-type(1), .in_recs .mmodity th:nth-of-type(1) {
        width: 70px;
    }

    .in_recs .mmodity th:nth-of-type(2), .in_recs .drag-list td:nth-of-type(2) {
        width: 130px;
    }

    .in_recs .drag-list td:nth-of-type(3), .in_recs .mmodity th:nth-of-type(3) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(4), .in_recs .mmodity th:nth-of-type(4) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(5), .in_recs .mmodity th:nth-of-type(5) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(6), .in_recs .mmodity th:nth-of-type(6) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(7), .in_recs .mmodity th:nth-of-type(7) {
        width: 180px;
    }

    .in_recs .drag-list td:nth-of-type(8), .in_recs .mmodity th:nth-of-type(8) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(9), .in_recs .mmodity th:nth-of-type(9) {
        width: 100px;
    }

    .in_recs .drag-list td:nth-of-type(10), .in_recs .mmodity th:nth-of-type(10) {
        width: 110px;
    }

    .in_recs .drag-list td:nth-of-type(11), .in_recs .mmodity th:nth-of-type(11) {
        width: 110px;
    }

    .in_recs .drag-list td:nth-of-type(12), .in_recs .mmodity th:nth-of-type(12) {
        width: 120px;
    }

    .in_recs .drag-list td:nth-of-type(13), .in_recs .mmodity th:nth-of-type(13) {
        width: 120px;
    }

    .in_recs .drag-list td:nth-of-type(14), .in_recs .mmodity th:nth-of-type(14) {
        width: 110px;
    }

    .in_recs .drag-list td:nth-of-type(15), .in_recs .mmodity th:nth-of-type(15) {
        width: 110px;
    }

    /* .in_recs .drag-list td:nth-of-type(16),.in_recs .mmodity th:nth-of-type(16){
        width: 110px;
    }
    .in_recs .drag-list td:nth-of-type(17),.in_recs .mmodity th:nth-of-type(17){
        width: 110px;
    } */
    .in_recs .drag-list:nth-of-type(odd) {
        background-color: #f9f9f9;
        color: #40404e;
    }

    .in_recs .drag-list:nth-of-type(even) {
        background-color: #f5f5f5;
        color: #40404e;
    }

    .in_recs .zhuixiaoi .el-checkbox__label {
        color: #40404e;
    }

    /*  */
    .in_recs .zhuixiaoi .chaoguogai {
        height: 20px;
        /* text-align: center; */
        line-height: 20px;
        width: 136px;
    ...
    /* 日期选择器 */
    .in_recs .in_recs-rkrq .rkrq .el-range-editor .el-range-input {
        background-color: rgba(0, 0, 0, 0);
        color: #40404e;
    }

    .in_recs .in_recs-rkrq .rkrq .el-date-editor .el-range-separator, .in_recs .in_recs-rkrq .rkrq .el-date-editor .el-range__icon {
        color: #40404e;
        line-height: 22px;
    }
    ...
    .in_recs .Pagination .el-pagination.is-background .btn-next, .in_recs .Pagination .el-pagination.is-background .btn-prev, .in_recs .Pagination .el-pagination.is-background .el-pager li {
        background-color: rgba(0, 0, 0, 0);
        border: 1px solid #606266;
        color: #40404e;
    }

    .in_recs .Pagination .btn-prev {
        background-color: rgba(0, 0, 0, 0);
        border: 1px solid #606266;
    }

    .in_recs .Pagination .el-pagination {
        padding: 0;
    }

    .in_recs .Pagination .el-pagination .btn-next .el-icon, .in_recs .Pagination .el-pagination .btn-prev .el-icon {
        color: #40404e;
    }

    .in_recs .Pagination .el-pagination.is-background .el-pager li:not(.disabled).active {
        color: #409EFF;
        background-color: rgba(0, 0, 0, 0);
        border: 1px solid #409EFF;
    }

    .in_recs .el-input__inner {
        height: 30px;
        line-height: 30px;
    }

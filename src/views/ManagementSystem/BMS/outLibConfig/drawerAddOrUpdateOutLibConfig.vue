  ...
  <div>
    ...
    >
      <div class="session p-5 erp-lib-detail fs14">
        ...
        <p class="red-color fs12 m-t-2" style="margin-left: 160px">
          用于打印出品单
        </p>
        ...
        <div class="coll" layout="row" layout-align="start center">
          ...
          <div class="value">
            ...
            <span
              class="primary-link fs14 cursor"
        ...
        <div class="coll" layout="row" layout-align="start center">
          ...
          <div class="value">
            <el-select
              v-model="connectLibVal"
              placeholder="请选择打印机"
              size="small"
              clearable
            >
              <el-option
                v-for="item in connectLibOption"
                :key="item.id"
                :label="item.n"
                :value="item.id"
              ></el-option>
        ...
        <div class="coll" layout="row" layout-align="start center">
          ...
          <div class="value">
            <el-input-number
              v-model="connectPrintCount"
              :max="3"
              :min="0"
              :disabled="!connectLibVal"
            />
          </div>
        </div>
        <p class="red-color fs12 m-t-2" style="margin-left: 160px">

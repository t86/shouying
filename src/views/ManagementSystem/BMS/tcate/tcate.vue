<template>
    <div class="tcate">
        <div class="tcate-controller">
            ...
            <icon-button @click.native="compiletcate" text="编辑" img="btn_edit.png" colors="#383943"></icon-button>
            ...
            <icon-button @click.native="tcatedel" text="批量删除" img="btn_delete.png" colors="#6B2830"

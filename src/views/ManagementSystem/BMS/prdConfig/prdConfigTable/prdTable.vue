<template>
  <div class="prd-table">
    <div class="top" layout="row" layout-align="start center">
      <icon-button @click.native="addOrUpdatePrdHandle(1)" text="新增" img="添加.png" colors="#383943"></icon-button>
      <icon-button @click.native="addOrUpdateGroupHandle(1)" text="新增套餐" img="新增套餐.png" colors="#f5f5f5"></icon-button>
      <icon-button @click.native="updatePrdOrGroupHandle(2)" text="编辑" img="编辑.png" colors="#383943"></icon-button>
      ...
      <icon-button @click.native="showImportDrawer = true" text="批量导入" img="批量导入.png" colors="#f5f5f5"></icon-button>

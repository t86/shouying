<template>
    <div class="printer">
        <div class="printer-controller">
            <icon-button @click.native="xingh" text="新增打印机" img="添加.png" colors="transparent"></icon-button>
            <icon-button @click.native="compileprinter" text="编辑" img="编辑.png" colors="transparent"></icon-button>
            <icon-button @click.native="noneffective" text="置为无效" img="无效.png" colors="transparent"></icon-button>
            <icon-button @click.native="effective" text="置为有效" img="有效.png" colors="transparent"></icon-button>
            <icon-button @click.native="printerdel" text="批量删除" img="删除.png" colors="transparent"

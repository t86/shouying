...
export const cardInfoMixins = {
  ...
  methods: {
    ...
    // async getAllData(loadCard = false, reload = false, init = false) {
    ...
    //   // 是否需要重新请求元素据
    //   const needReloadData = (!(resResultDataObj && resResultDataObj.areaInfo)) || (!window.sessionStorage.getItem('websocketTimeMessageTime'))
    //   try {
    //     let res = {}
    ...
    //           const allCardInfo = [...resResultDataObj.cardInfo] || []
    ...
    //           const allAreaInfo = [...resResultDataObj.areaInfo] || []
    //           areaIdList.forEach(el => {
    //             const find = allAreaInfo.find(item => item.id == el)
    //             resultAreaList.push(find)
    //           })
    //           resResultDataObj.areaInfo = resultAreaList.map(item => ({
    //             ...item,
    ...
    //           }))
    //           resResultDataObj.cardInfo = resultCardList

    //         }

    //         console.log('new-resResultDataObj:', resResultDataObj);
    ...
    //         console.log('old-resResultDataObj:', resResultDataObj);
    //       }
    ...
    // async getUpdateData() {
    //   this.websocketTimeMessageTime = window.sessionStorage.getItem('websocketTimeMessageTime') || ''
    ...
    //     res.code == 1 ? this.updateCardList(data, this.websocketTimeMessageTime) : this.$message.warning(res.msg)
    ...
    //   code == 1 ? this.updateCardList(data, this.websocketTimeMessageTime) : (code == 3 ? this.$message.warning(typeof data == 'string' ? data : 'websocket返回数据出错') : window.sessionStorage.setItem('websocketTimeMessageTime', time))
    // },
    ...
    //   if(time) window.sessionStorage.setItem('websocketTimeMessageTime', time)
    // },
